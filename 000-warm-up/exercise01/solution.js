...
const result = addStrings("hej", "kup se klej");

console.log(result);

// ⭐⭐
const addStrings1 = (stringOrStringArr, string2) => {
  if (typeof stringOrStringArr === "string") {
    return `${stringOrStringArr};${string2}`;
  }

  return stringOrStringArr.join(";");
};

const result1 = addStrings1("hej", "kup se klej");
const result2 = addStrings1(["hej", "kup", "se klej"]);
